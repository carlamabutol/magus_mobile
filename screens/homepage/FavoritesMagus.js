...
const FavoritesMagus =({navigation})=>{
  ...
  return(
    <ImageBackground source={require('../../assets/homebg.png')} style={{width: width, height: height}}>
      <TouchableOpacity onPress={() =>[navigation.navigate("MeFree1"), setData1([])]} style={{width: 40, height: 40, left: 15, marginTop: 48}} >
      ...
      <View style={{flexDirection: 'row', justifyContent: 'center', marginTop: 20}}>
        <TouchableOpacity onPress={()=> navigation.navigate("Favorites")} style={{backgroundColor: 'rgba(4,157,217,1)', width: 120, height: 38, borderRadius: 15, flexDirection: 'row', justifyContent: 'center', marginRight: 10, shadowOpacity: 0.5, shadowOffset: {width: .5, height: .5}, shadowColor: 'black',}}>
